...
const FilmsTV = () => {
    ...
    return (
        <View style={{ flex: 1, flexDirection: 'column', backgroundColor: 'transparent', alignItems: 'center', justifyContent: 'space-evenly', height: 279, marginTop: '0%', bottom: '17%' }}>
            <View style={{
                width: '100%',
                height: '30%',
                fontSize: 15,
